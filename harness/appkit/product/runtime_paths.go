...
func detectedEnvVars() []string {
	keys := []string{
		"MOSSCODE_PROVIDER", "MOSSCODE_NAME", "MOSSCODE_MODEL", "MOSSCODE_WORKSPACE", "MOSSCODE_TRUST", "MOSSCODE_API_KEY", "MOSSCODE_BASE_URL",
		"MOSS_PROVIDER", "MOSS_NAME", "MOSS_MODEL", "MOSS_WORKSPACE", "MOSS_TRUST", "MOSS_API_KEY", "MOSS_BASE_URL",
	}

...
func TestRegisterProgressiveSkillTools_NilKernel(t *testing.T) {
	err := capstate.RegisterProgressiveSkillTools(nil)
	if err == nil {
...
func TestRegisterProgressiveSkillTools_Success(t *testing.T) {
	k := kernel.New()
	err := capstate.RegisterProgressiveSkillTools(k)
	if err != nil {
...
func TestRegisterProgressiveSkillTools_Idempotent(t *testing.T) {
	k := kernel.New()
	if err := capstate.RegisterProgressiveSkillTools(k); err != nil {
		t.Fatal(err)
	}
	if err := capstate.RegisterProgressiveSkillTools(k); err != nil {
...
func TestListSkillsTool_WithManifests(t *testing.T) {
	k := kernel.New()
	capstate.SetSkillManifests(k, []skill.Manifest{

...
| P0-DOC-001 | P0 | docs | ready | - | - | 2026-04-08 | draft rollback handbook and one drill record |
...
| BATCH-P0-02 | P0-EVAL-002,P0-DOC-001 | running | 2026-04-08 | - | `go test ./testing/eval/...` pass | baseline compare + gate(report-only capable) completed |

...
func ResolveToolPolicyForWorkspace(workspace, trust, approvalMode string) ToolPolicy {
	return normalizeResolvedToolPolicy(resolveToolPolicy(trust, approvalMode, commandPolicyDefaults(nil, workspace, nil)))
}
...
func toolPolicyOf(k *kernel.Kernel) ToolPolicy {
	...
	return normalizeResolvedToolPolicy(resolveToolPolicyForKernel(k, appconfig.TrustRestricted, "confirm"))
}
...
func resolveToolPolicyForKernel(k *kernel.Kernel, trust, approvalMode string) ToolPolicy {
	...
	return normalizeResolvedToolPolicy(resolveToolPolicy(trust, approvalMode, commandPolicyDefaults(sb, "", nil)))
}

...
} from "../../bindings/github.com/mossagents/moss/apps/mosswork";
...
export const ChatService = {
  ...
  setSwarmParams: (breadth: number, depth: string, outputLength: string) => _Chat.SetSwarmParams(breadth, depth, outputLength),
};

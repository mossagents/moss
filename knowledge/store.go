...
type Store interface {
	...
	Add(ctx context.Context, embedder model.Embedder, id, source string, texts []string, metadata map[string]any) error

	// Search 语义搜索，返回 top-k 最相关的文本块。
	Search(ctx context.Context, embedder model.Embedder, query string, limit int) ([]SearchResult, error)

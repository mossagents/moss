...
func applyPlainTheme() {
	...
	composerBoxStyle = lipgloss.NewStyle().Border(lipgloss.RoundedBorder()).Padding(0, 1)
...
func applyDarkTheme() {
	...
	inputBorderStyle = lipgloss.NewStyle().Background(lipgloss.Color(hexBgPanel)).Border(lipgloss.RoundedBorder()).BorderForeground(lipgloss.Color(hexBorder)).Padding(0, 1)
	composerBoxStyle = lipgloss.NewStyle().Background(lipgloss.Color(hexBgPanel)).Border(lipgloss.RoundedBorder()).BorderForeground(lipgloss.Color(hexBorder)).Padding(0, 1)
...
func applyDefaultTheme() {
	...
	composerBoxStyle = lipgloss.NewStyle().Border(lipgloss.RoundedBorder()).BorderForeground(colorBorder).Padding(0, 1)

	...
	events := []observe.ExecutionEvent{
		{
			...
			SessionID: sess.ID,
			Timestamp: base,
			Metadata:  map[string]any{"max_steps": 12},
		},
		{
			Type:      observe.ExecutionIterationStarted,
			SessionID: sess.ID,
			Timestamp: base.Add(1 * time.Second),
			Metadata:  map[string]any{"iteration": 1, "max_steps": 12},
		},
		{
			Type:      observe.ExecutionRunCompleted,
			SessionID: sess.ID,
			Timestamp: base.Add(2 * time.Second),
			Metadata:  map[string]any{"steps": 1, "tokens": 20},
		},
		{
			Type:      observe.ExecutionRunStarted,
			SessionID: sess.ID,
		...
		},
		{
			...
			Metadata:  map[string]any{"iteration": 2, "max_steps": 12},
		},
		{
